            ...
            <div className="experience-container">
                <div className="languages-container">
                    ...
                    <div className="languages-list">
                        <div className="python large-3D-text">
                            Python
                        </div>
                        <div className="c large-3D-text">
                            C
                        </div>
                        <div className="js large-3D-text">
                            JavaScript
                        </div>
                        <div className="bash medium-3D-text">
                            Bash
                        </div>
                        <div className="cpp medium-3D-text">
                            C++
                        </div>
                        <div className="html medium-3D-text">
                            HTML
                        </div>
                        <div className="css medium-3D-text">
                            CSS
                        </div>
                        <div className="csharp medium-3D-text">
                            C#
                        </div>
                        <div className="swift small-3D-text">
                            Swift
                        </div>
                        <div className="scheme small-3D-text">
                            Scheme
                        </div>
                        <div className="sml small-3D-text">
                            SML
                        </div>
                        <div className="haskell small-3D-text">
                            Haskell
                        </div>
                    </div>
                </div>
                <div className="technologies-container">
                    ...
                    <div className="technologies-list">
                        <div className="github large-3D-text">
                            GitHub
                        </div>
                        <div className="unity large-3D-text">
                            Unity
                        </div>
                        <div className="linux large-3D-text">
                            Linux
                        </div>
                        <div className="docker medium-3D-text">
                            Docker
                        </div>
